...
## Inputs
- Topic: [landing page for describing parenting, make it about how its hard for parents, make it in fun little banter way.]
...
- Style direction: [ Optional. Choose one dominant direction. Representative anchors: Swiss, Editorial, Organic, Terminal, Playful, Neo-Brutalist, Industrial, Synthwave. You may choose one different direction if it fits the topic better.]
...
Any additional surface must obey the single-surface rule.
